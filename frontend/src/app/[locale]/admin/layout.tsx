...
import { LayoutDashboard, Users, FileText, AlertTriangle, Building2, Settings, BarChart3 } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-64 flex-shrink-0">
            <nav className="bg-white rounded-[var(--radius-lg)] p-4 space-y-1">
              ...
              <Link href="/admin/analytics" className="flex items-center gap-3 px-4 py-3 rounded-[var(--radius-md)] hover:bg-[var(--gray-50)] text-[var(--gray-700)]">
                <BarChart3 className="w-5 h-5" /> 분석 대시보드
              </Link>
