          ...
          <CardContent className="prose prose-gray max-w-none">
            <section className="mb-8">
              ...
              <p className="text-[var(--gray-700)]">
                이 약관은 행복사회당(이하 &ldquo;당&rdquo;)이 운영하는 웹사이트(이하 &ldquo;사이트&rdquo;)에서 제공하는
                인터넷 관련 서비스(이하 &ldquo;서비스&rdquo;)를 이용함에 있어 당과 이용자의 권리, 의무 및
                책임사항을 규정함을 목적으로 합니다.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ol className="list-decimal list-inside space-y-2 text-[var(--gray-700)]">
                <li>&ldquo;사이트&rdquo;란 당이 서비스를 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 설정한 가상의 공간을 말합니다.</li>
                <li>&ldquo;이용자&rdquo;란 사이트에 접속하여 이 약관에 따라 당이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.</li>
                <li>&ldquo;회원&rdquo;이란 사이트에 개인정보를 제공하여 회원등록을 한 자로서, 사이트의 정보를 지속적으로 제공받으며, 사이트가 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다.</li>
                <li>&ldquo;당원&rdquo;이란 회원 중 정당법에 따라 당원으로 가입한 자를 말합니다.</li>
              </ol>
            </section>
