...
import { User, CreditCard, Bell, Settings, MapPin, ClipboardList, FileText, MessageSquare, Heart, Loader2 } from 'lucide-react';
            ...
            <Card variant="default" className="bg-white">
              ...
              <CardContent>
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 bg-[var(--primary-light)] rounded-full flex items-center justify-center overflow-hidden">
                    {profile.avatar_url ? (
